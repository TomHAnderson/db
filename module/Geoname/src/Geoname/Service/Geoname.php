...
class Geoname
{
    ...
    public function installPlace()
    {
        $em = $this->getEntityManager();
        $featureRepo =
            $em->getRepository('Geoname\Entity\Feature');
    ...
    public function installCountryCurrencyLocale()
    {
        $em = $this->getEntityManager();
        $placeRepo =
            $em->getRepository('Geoname\Entity\Place');
        $languageRepo =
            $em->getRepository('Geoname\Entity\Language');
        $currencyMap = array();
        $localeMap = array();
        $languageMap = array();
        $continentMap = array(
    ...
    public function installTimezone()
    {
        $em = $this->getEntityManager();
        $countryRepo =
            $em->getRepository('Geoname\Entity\Country');
    ...
    public function installPlaceTimezone()
    {
        ...
        $placeRepo =
            $em->getRepository('Geoname\Entity\Place');
        $timezoneRepo =
            $em->getRepository('Geoname\Entity\Timezone');
        $countryRepo =
            $em->getRepository('Geoname\Entity\Country');
    ...
    public function updateAltNameModify()
    {
        $em = $this->getEntityManager();
        $altNameRepo =
            $em->getRepository('Geoname\Entity\AltName');
        $placeRepo =
            $em->getRepository('Geoname\Entity\Place');
        $languageRepo =
            $em->getRepository('Geoname\Entity\Language');
