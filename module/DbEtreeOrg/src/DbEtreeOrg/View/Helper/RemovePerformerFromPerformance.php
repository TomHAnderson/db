...
final class RemovePerformerFromPerformance extends AbstractHelper implements ServiceLocatorAwareInterface {
    ...
    public function __invoke($id)
    {
        ...
        $model = new ViewModel();
        $model->setTemplate('db-etree-org/helper/remove-performer-from-performance.phtml');
